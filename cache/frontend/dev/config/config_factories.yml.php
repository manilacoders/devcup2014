...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/devcup2014/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/devcup2014/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/devcup2014/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/devcup2014/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/devcup2014/apps/frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'devcup2014noreply@gmail.com',
      'password' => 'phillip-kenn-daison',
    ),
  ),
))));
